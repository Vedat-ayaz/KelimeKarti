...
const styles = StyleSheet.create({ row: { flexDirection: 'row', gap: 8 }, chip: { borderWidth: StyleSheet.hairlineWidth, borderRadius: 12, paddingHorizontal: 13, paddingVertical: 9 } });
